...
// select and store all h4 elements
var siteH4 = document.querySelectorAll("h4");
for(var headerChild = 0; headerChild < siteH4.length; headerChild++)
{
    siteH4[headerChild].setAttribute("style", "font-size:30px; font-weight:bold;color:blue");
}
